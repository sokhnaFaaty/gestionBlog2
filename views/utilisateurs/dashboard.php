<div class="h-full flex flex-col gap-4">
    ...
    <!-- Stats -->
    <div class="rounded-[10px] bg-gray-100 p-3 sm:p-4">

        <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
            <div class="bg-[#EEF0FF] rounded-[5px] border-r-4 border-[#1A237E] shadow-sm p-4">
                <p class="text-xs text-[#1A237E] uppercase font-semibold tracking-wide">Articles total</p>
                <p class="text-2xl font-bold text-[#1A237E] mt-1"><?= $total_articles ?></p>
            </div>
            <div class="bg-[#FFFAF1] rounded-[5px] border-r-4 border-[#9A7B40] shadow-sm p-4">
                <p class="text-xs text-[#9A7B40] uppercase font-semibold tracking-wide">En attente</p>
                <p class="text-2xl font-bold text-[#9A7B40] mt-1"><?= $articles_en_attente ?></p>
            </div>
            <div class="bg-[#E3FFE7] rounded-[5px] border-r-4 border-[#096D16] shadow-sm p-4">
                <p class="text-xs text-[#096D16] uppercase font-semibold tracking-wide">Publiés</p>
                <p class="text-2xl font-bold text-[#096D16] mt-1"><?= $articles_publies ?></p>
            </div>
            <div class="bg-[#FFECEC] rounded-[5px] border-r-4 border-[#FD0D0D] shadow-sm p-4">
                <p class="text-xs text-[#FD0D0D] uppercase font-semibold tracking-wide">Rejetés</p>
                <p class="text-2xl font-bold text-[#FD0D0D] mt-1"><?= $articles_rejetes ?></p>
            </div>
            <div class="bg-[#EFEFEF] rounded-[5px] border-r-4 border-[#000000] shadow-sm p-4">
                <p class="text-xs text-[#000000] uppercase font-semibold tracking-wide">Auteurs</p>
                <p class="text-2xl font-bold text-[#000000] mt-1"><?= $total_auteurs ?></p>
            </div>
            <div class="bg-[#F8F3FF] rounded-[5px] border-r-4 border-[#9747FF] shadow-sm p-4">
                <p class="text-xs text-[#9747FF] uppercase font-semibold tracking-wide">Commentaires</p>
                <p class="text-2xl font-bold text-[#9747FF] mt-1"><?= $total_commentaires ?></p>
            </div>
        </div>

    </div>

    <!-- Derniers articles (prend la hauteur restante, sans scrollbar) -->
    <div class="bg-white rounded-xl border border-gray-100 shadow-sm flex-1 min-h-0 flex flex-col">
